package fi.kaicao.webapp.filter;
    ...
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
        ...
        if (session != null) {
            if (preferredLocale == null) {
                preferredLocale = (Locale) session.getAttribute("org.apache.struts.action.LOCALE");
            } else {
                session.setAttribute("org.apache.struts.action.LOCALE", preferredLocale);
